...
pub fn export_image(pdf: &Pdfium, path: &PathBuf, out_path: &PathBuf, format: ExportFormat, msg_tx: &Sender<PdfWorkerMessage>, ctx: &egui::Context, cancel_flag: &AtomicBool) -> Result<String, String> {
    use std::io::Write;
...
pub fn export_docx(pdf: &Pdfium, path: &PathBuf, out_path: &PathBuf, retain_layout: bool, include_images: bool, msg_tx: &Sender<PdfWorkerMessage>, ctx: &egui::Context, cancel_flag: &AtomicBool) -> Result<String, String> {
...
pub fn export_doc_rtf(pdf: &Pdfium, path: &PathBuf, out_path: &PathBuf, retain_layout: bool, include_images: bool, msg_tx: &Sender<PdfWorkerMessage>, ctx: &egui::Context, cancel_flag: &AtomicBool) -> Result<String, String> {
    let doc = pdf.load_pdf_from_file(path, None)
